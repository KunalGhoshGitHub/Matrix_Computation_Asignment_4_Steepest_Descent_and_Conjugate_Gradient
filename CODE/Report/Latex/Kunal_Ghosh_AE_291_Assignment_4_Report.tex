\documentclass[11pt]{article}
    ...
    % Document parameters
    % Document title
    \title{Kunal\_Ghosh\_AE\_291\_Assignment\_4\_Report}
...
\PY{k}{for} \PY{n}{h} \PY{o+ow}{in} \PY{n}{H}\PY{p}{:}
    ...
    \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{u}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{:}
        \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{u}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{:}
            \PY{n}{b}\PY{p}{[}\PY{n}{I}\PY{p}{[}\PY{n}{i}\PY{p}{,}\PY{n}{j}\PY{p}{]}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{=}  \PY{p}{(}\PY{p}{(}\PY{n}{h}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}\PY{o}{*}\PY{n}{f}\PY{p}{(}\PY{n}{x}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{,}\PY{n}{y}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{)}\PY{p}{)}
            \PY{k}{if} \PY{n}{i} \PY{o}{==} \PY{l+m+mi}{0}\PY{p}{:} 
                \PY{n}{b}\PY{p}{[}\PY{n}{I}\PY{p}{[}\PY{n}{i}\PY{p}{,}\PY{n}{j}\PY{p}{]}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{=} \PY{n}{u\PYZus{}linear}\PY{p}{[}\PY{n}{I}\PY{p}{[}\PY{n}{i}\PY{p}{,}\PY{n}{j}\PY{p}{]}\PY{p}{]}
...
\end{tcolorbox}
    ...
    \hypertarget{answer-1-conjugate-gradient-cg}{%
\subsection{Answer (1): Conjugate Gradient
(CG)}\label{answer-1-conjugate-gradient-cg}}
...
\subsection{A dictionary to store u}\label{a-dictionary-to-store-u}}
    ...
    \hypertarget{note-we-will-be-storing-u-such-that-u-in-mathbbr2}{%
\subsection{\texorpdfstring{NOTE: We will be storing u such that
\(u \in \mathbb{R}^{2}\)}{NOTE: We will be storing u such that u \textbackslash{}in \textbackslash{}mathbb\{R\}\^{}\{2\}}}\label{note-we-will-be-storing-u-such-that-u-in-mathbbr2}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{CG\PYZus{}Solver}\PY{p}{(}\PY{n}{r}\PY{p}{,}\PY{n}{u}\PY{p}{,}\PY{n}{U}\PY{p}{,}\PY{n}{Error}\PY{p}{,}\PY{n}{Tolerance}\PY{p}{,}\PY{n}{f}\PY{p}{,}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{,}\PY{n}{h}\PY{p}{,}\PY{n}{n}\PY{p}{,}\PY{n}{n\PYZus{}x}\PY{p}{,}\PY{n}{n\PYZus{}y}\PY{p}{)}\PY{p}{:}
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
\PY{l+s+sd}{    CG\PYZus{}Solver(b,u,U,Error,Tolerance,f,x,y,h,n\PYZus{}x,n\PYZus{}y): Solves the given poisson equation using the Conjugate Gradient (CG) method}
\PY{l+s+sd}{    r: r is the residual but b is stored in r, where Au = b and r = b\PYZhy{}(Au)}
\PY{l+s+sd}{    u: Initial value of u in the computational domain}
\PY{l+s+sd}{    U: Dictionary to store u for different values of h}
\PY{l+s+sd}{    Error: Dictionary to store error at each iterations for different values of h}
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    ...
    \PY{c+c1}{\PYZsh{} Conjugate Gradient (CG) method}
    ...
    \PY{k}{while} \PY{n}{temp} \PY{o}{\PYZgt{}}\PY{o}{=} \PY{n}{Tolerance}\PY{p}{:}
        ...
        \PY{c+c1}{\PYZsh{} q = AP}
        \PY{n}{q} \PY{o}{=} \PY{n}{MatMul\PYZus{}A\PYZus{}Vector}\PY{p}{(}\PY{n}{P}\PY{p}{,}\PY{n}{n}\PY{p}{,}\PY{n}{n\PYZus{}x}\PY{p}{)}
        \PY{n}{alpha} \PY{o}{=} \PY{n}{MatMul}\PY{p}{(}\PY{n}{r}\PY{o}{.}\PY{n}{T}\PY{p}{,}\PY{n}{r}\PY{p}{)}\PY{o}{/}\PY{n}{MatMul}\PY{p}{(}\PY{n}{P}\PY{o}{.}\PY{n}{T}\PY{p}{,}\PY{n}{q}\PY{p}{)}
        \PY{n}{u} \PY{o}{=} \PY{n}{u} \PY{o}{+} \PY{p}{(}\PY{n}{alpha}\PY{o}{*}\PY{n}{P}\PY{p}{)}
        \PY{n}{r\PYZus{}old} \PY{o}{=} \PY{n}{r}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{p}{)}
        \PY{n}{r} \PY{o}{=} \PY{n}{r} \PY{o}{\PYZhy{}} \PY{p}{(}\PY{n}{alpha}\PY{o}{*}\PY{n}{q}\PY{p}{)}
        \PY{n}{beta} \PY{o}{=} \PY{n}{MatMul}\PY{p}{(}\PY{n}{r}\PY{o}{.}\PY{n}{T}\PY{p}{,}\PY{n}{r}\PY{p}{)}\PY{o}{/}\PY{n}{MatMul}\PY{p}{(}\PY{n}{r\PYZus{}old}\PY{o}{.}\PY{n}{T}\PY{p}{,}\PY{n}{r\PYZus{}old}\PY{p}{)}
        \PY{n}{P}\PY{o}{=} \PY{n}{r} \PY{o}{+} \PY{p}{(}\PY{n}{beta}\PY{o}{*}\PY{n}{P}\PY{p}{)}
...
\PY{k}{for} \PY{n}{h} \PY{o+ow}{in} \PY{n}{H}\PY{p}{:}
    ...
    \PY{c+c1}{\PYZsh{} Solving the system of equation using CG Method}
    \PY{c+c1}{\PYZsh{} NOTE: b will be modified after the excution of this function}
    \PY{n}{CG\PYZus{}Solver}\PY{p}{(}\PY{n}{b}\PY{p}{,}\PY{n}{u\PYZus{}linear}\PY{p}{,}\PY{n}{U}\PY{p}{,}\PY{n}{Error}\PY{p}{,}\PY{n}{Tolerance}\PY{p}{,}\PY{n}{f}\PY{p}{,}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{,}\PY{n}{h}\PY{p}{,}\PY{n}{n}\PY{p}{,}\PY{n}{n\PYZus{}x}\PY{p}{,}\PY{n}{n\PYZus{}y}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \hypertarget{answer-2-conjugate-gradient-cg}{%
\subsection{Answer (2): Conjugate Gradient
(CG)}\label{answer-2-conjugate-gradient-cg}}
...
\PY{k}{for} \PY{n}{h}\PY{p}{,}\PY{n}{u} \PY{o+ow}{in} \PY{n}{U}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{y}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}zlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{u}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Conjugate Gradient (CG): h = }\PY{l+s+si}{\PYZob{}}\PY{n}{h}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}box\PYZus{}aspect}\PY{p}{(}\PY{n}{aspect}\PY{o}{=}\PY{k+kc}{None}\PY{p}{,} \PY{n}{zoom}\PY{o}{=}\PY{l+m+mf}{0.75}\PY{p}{)}
    \PY{n}{ax}\PY{o}{.}\PY{n}{patch}\PY{o}{.}\PY{n}{set\PYZus{}edgecolor}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{black}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}  
    \PY{n}{ax}\PY{o}{.}\PY{n}{patch}\PY{o}{.}\PY{n}{set\PYZus{}linewidth}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)}  
\PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_165_2.png}
    \end{center}
    { \hspace*{\fill} \\}
